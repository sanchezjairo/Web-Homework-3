...
def image_filter():
    ...
    if request.method == 'POST':
        ...
        # Gets the user's chosen filter type (whichever one they chose in the form) and save
        # as a variable
...
def gif_search():
    ...
    if request.method == 'POST':
        ...
        numb_gifs = request.form.get('quantity')
        ...
        gifts_urls = []
        for numb in range(int(numb_gifs)):
            gifts_urls.append(gifs[numb]['media'][0]['gif']['url'])
